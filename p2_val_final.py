...
import numpy as np
from p2_Dataset_final import p2_dataset
import torchvision.models as models
from PIL import Image
from p2_modelfcn8_modify import fcn8
...
if __name__ == '__main__':
    ...
    load_checkpoint('p2-final-24734-best-miou-0.7305.pth', model, optimizer)
    ...
    testset = p2_dataset(root=testing_image_directory_root, transform=testset_augmentation, mode='test')
